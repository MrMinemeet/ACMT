...
{A camera delivers a sequence of 2D pictures of the environment in front of a car. Only sing these pictures the programm should generate a 3D map. Since the pictures don't contain any depth information a SLAM (Simultaneous Localization and Mapping) should be applied.} \\
