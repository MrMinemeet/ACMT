...
Simplified a ANN consists of three main components(neurons, connection and the weight associated with them) the propagation function an a bias. In the following topics I will give you a short summary what these components are and afterward I will explain how they work together. 
...
The following picture demonstrates a feed forward ANN .There are a variable number of hidden layers depending on the purpose of the neural network. Nothing in the hidden layer visible. 

\subsection{Feedback ANN}
